...
KERNEL_PATH := device/lava/lxx521-kernel
...
# Kernel
TARGET_PREBUILT_KERNEL := $(KERNEL_PATH)/images/kernel
PRODUCT_COPY_FILES += \
...
TARGET_KERNEL_SOURCE := device/lava/lxx521-kernel/kernel-headers
...
BOARD_MKBOOTIMG_ARGS += --dtb $(BOARD_PREBUILT_DTBIMAGE_DIR)/mt6878.dtb

# Kernel modules
DLKM_MODULES_PATH := $(KERNEL_PATH)/modules/vendor_dlkm
RAMDISK_MODULES_PATH := $(KERNEL_PATH)/modules/vendor_boot
SYSTEM_DLKM_MODULES_PATH := $(KERNEL_PATH)/modules/system_dlkm
...
BOARD_MEDIATEK_DYNAMIC_PARTITIONS_SIZE := 11270094848
